...
let rulesContent: [RulesSection] = [
	...
	RulesSection(
		...
		blocks: [
			...
			.paragraph("If the point number is rolled again before a 7, Pass Line bets win and the round ends."),
			.paragraph("If a 7 is rolled before the point, this is called a seven out. The round ends, Pass Line bets lose, and the dice move to the next shooter.")
		]
	),
	...
	RulesSection(
		...
		blocks: [
			...
			.subSection(
				title: "Odds Bets",
				blocks: [
					.paragraph("Odds bets pay true odds."),
					.bulletList([
			...
			.subSection(
				title: "Place Bets",
				blocks: [
					.paragraph("Place bets usually pay less than true odds."),
					.bulletList([
			...
			.subSection(
				...
				blocks: [
					...
					.paragraph("Most numbers pay 1 to 1."),
